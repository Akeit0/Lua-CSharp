...
debug.sethook(function (e, l)
  if l == 3 then a = a + 1; assert(debug.getlocal(2, 1) == nil)--"(*temporary) in lua ")
...
checktraceback(co, {"yield", "in function <"},nil)
...
print"check traceback of suspended (or dead with error) coroutines"
